...
setCombatParam(combat2_auraeletrica, COMBAT_PARAM_EFFECT, 116)
...
setCombatParam(combat3_auraeletrica3, COMBAT_PARAM_EFFECT, CONST_ME_EXPLOSIONAREA)
...
setCombatParam(combat7_auraeletrica, COMBAT_PARAM_EFFECT, 116)
