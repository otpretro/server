...
local check = db.getResult("SELECT `crystals` FROM `players` WHERE `id` = " .. getPlayerGUID(cid) .. " LIMIT 1")
return check:getDataInt("crystals") <= 0 and 0 or check:getDataInt("crystals") end

function addPoints(cid,amount)
db.executeQuery("UPDATE `players` SET `crystals` = "..getPoints(cid).."+"..amount.." WHERE `id` = "..getPlayerGUID(cid)) end
...
db.executeQuery("UPDATE `players` SET `crystals` = "..value.." WHERE `id` = "..getPlayerGUID(cid)) end




function getCatch(cid)
local check2 = db.getResult("SELECT `catch` FROM `players` WHERE `id` = " .. getPlayerGUID(cid) .. " LIMIT 1")
return check2:getDataInt("catch") <= 0 and 0 or check2:getDataInt("catch") end

function addCatch(cid,amount)
db.executeQuery("UPDATE `players` SET `catch` = "..getCatch(cid).."+"..amount.." WHERE `id` = "..getPlayerGUID(cid)) end

function removeCatch(cid,amount)
db.executeQuery("UPDATE `players` SET `catch` = "..getCatch(cid).."-"..amount.." WHERE `id` = "..getPlayerGUID(cid)) end


function setCatch(cid,value)
db.executeQuery("UPDATE `players` SET `catch` = "..value.." WHERE `id` = "..getPlayerGUID(cid)) end



function getPkkill(cid)
local check3 = db.getResult("SELECT `pokemonkill` FROM `players` WHERE `id` = " .. getPlayerGUID(cid) .. " LIMIT 1")
return check3:getDataInt("pokemonkill") <= 0 and 0 or check3:getDataInt("pokemonkill") end

function addPkkill(cid,amount)
db.executeQuery("UPDATE `players` SET `pokemonkill` = "..getPkkill(cid).."+"..amount.." WHERE `id` = "..getPlayerGUID(cid)) end

function removePkkill(cid,amount)
db.executeQuery("UPDATE `players` SET `pokemonkill` = "..getPkkill(cid).."-"..amount.." WHERE `id` = "..getPlayerGUID(cid)) end


function setPkkill(cid,value)
db.executeQuery("UPDATE `players` SET `pokemonkill` = "..value.." WHERE `id` = "..getPlayerGUID(cid)) end
...
function getCs(cid)
local check5 = db.getResult("SELECT `cassino` FROM `players` WHERE `id` = " .. getPlayerGUID(cid) .. " LIMIT 1")
return check5:getDataInt("cassino") <= 0 and 0 or check5:getDataInt("cassino") end

function addCs(cid,amount)
db.executeQuery("UPDATE `players` SET `cassino` = "..getCs(cid).."+"..amount.." WHERE `id` = "..getPlayerGUID(cid)) end

function removeCs(cid,amount)
db.executeQuery("UPDATE `players` SET `cassino` = "..getCs(cid).."-"..amount.." WHERE `id` = "..getPlayerGUID(cid)) end


function setCs(cid,value)
db.executeQuery("UPDATE `players` SET `cassino` = "..value.." WHERE `id` = "..getPlayerGUID(cid)) end


function getPkd(cid)
local check6 = db.getResult("SELECT `pokedex` FROM `players` WHERE `id` = " .. getPlayerGUID(cid) .. " LIMIT 1")
return check6:getDataInt("pokedex") <= 0 and 0 or check6:getDataInt("pokedex") end

function addPkd(cid,amount)
db.executeQuery("UPDATE `players` SET `pokedex` = "..getPkd(cid).."+"..amount.." WHERE `id` = "..getPlayerGUID(cid)) end

function removePkd(cid,amount)
db.executeQuery("UPDATE `players` SET `pokedex` = "..getPkd(cid).."-"..amount.." WHERE `id` = "..getPlayerGUID(cid)) end


function setPkd(cid,value)
db.executeQuery("UPDATE `players` SET `pokedex` = "..value.." WHERE `id` = "..getPlayerGUID(cid)) end
