local poke = {'Magikarp', 'Poliwag', 'Milotic', 'Shiny Feraligatr', 'Shiny Milotic', 'Poliwhirl', 'Seaking', 'Dewgong', 'Blastoise', 'Tentacruel', 'Lapras', 'Gyarados', 'Shiny Gyarados', 'Shiny Gyarados', 'Shiny Tentacruel', 'Shiny Tentacool', 'Shiny Blastoise', 'Omastar', 'Kabutops', 'Vaporeon', 'Staryu', 'Starmie', 'Goldeen', 'Seadra', 'Golduck', 'Squirtle', 'Wartortle', 'Tentacool', 'Snorlax', 'Poliwrath'}
local surf = {
...
["Magikarp"] = {lookType=2266, speed = 4000},
...
["Shiny Milotic"] = {lookType=1802, speed = 10000},
["Shiny Feraligatr"] = {lookType=2105, speed = 10000},
["Milotic"] = {lookType=823, speed = 10000},
}
...
doCreatureSay(cid, "" .. getItemAttribute(item.uid, "poke"):match("This is (.-)'s pokeball.")..", vamos sair do surf!", 1)
