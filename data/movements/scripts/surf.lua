local poke = {'Magikarp', 'Poliwag', 'Milotic', 'Shiny Feraligatr', 'Shiny Milotic', 'Poliwhirl', 'Seaking', 'Dewgong', 'Blastoise', 'Tentacruel', 'Lapras', 'Gyarados', 'Red Gyarados', 'Shiny Tentacruel', 'Shiny Tentacool', 'Shiny Blastoise', 'Omastar', 'Kabutops', 'Vaporeon', 'Staryu', 'Starmie', 'Goldeen', 'Seadra', 'Golduck', 'Squirtle', 'Wartortle', 'Tentacool', 'Snorlax', 'Poliwrath', 'Azumarill', 'Croconaw', 'Staryu', 'Feraligatr', 'Kingdra', 'Mantine', 'Octillery', 'Quagsire', 'Totodile', 'Wooper', 'Shiny Seadra', 'Big Magikarp', 'Shiny Big Magikarp'}
...
["Magikarp"] = {lookType=3535, speed = 4000},
...
["Feraligatr"] = {lookType=603, speed = 8500},
...
["Shiny Milotic"] = {lookType=1731, speed = 10000},
["Shiny Feraligatr"] = {lookType=2106, speed = 10000},
["Milotic"] = {lookType=880, speed = 10000},
}
...
if getPlayerStorageValue(cid, 63215) ~= 1 and getPlayerStorageValue(cid, 17000) <= 0 then
	...
	doPlayerSendCancel(cid, "Voce precisa de um pokemon com habilidade de Surf.")
	doTeleportThing(cid, fromPosition, false)
	else
...
pokenome = getItemAttribute(ball.uid, "poke"):match("This is (.-)'s pokeball.")
	...
	doPlayerSendCancel(cid, "O Pokemon com o qual esta, nao possui habilidade Surf.")
	doTeleportThing(cid, fromPosition, false)
	return true
	end
	end
...
doPlayerSendCancel(cid, "Precisa sair da (BIKE).")
doTeleportThing(cid, fromPosition, false)
return true
end
...
doCreatureSay(cid, ""..pokenome..", vamos surfar!", 1)
