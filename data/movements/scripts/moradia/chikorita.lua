...
doPlayerSendTextMessage(cid, 27, "Você pegou seu primeiro pokémon (Chikorita) e alguns itens, para lhe ajudar em sua jornada, há não esqueça de usar a pokedex para saber mais sobre o seu pokémon e Boa sorte!")
else
